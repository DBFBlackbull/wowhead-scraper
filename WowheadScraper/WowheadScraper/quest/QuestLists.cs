...
public class QuestLists
{
    ...
    public static readonly Dictionary<int, string> TbcQuestsIDs = new Dictionary<int, string>()
    {
    ...
    public static readonly Dictionary<int, string> WotLkQuestsIDs = new Dictionary<int, string>()
    {
    ...
    public static readonly HashSet<int> BattlegroundQuests = new HashSet<int>()
    {
        // AV Quests
